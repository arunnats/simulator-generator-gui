...
import InstructionCardFormik from "@/components/guicard/instructioncard/InstructionCard";
...
export default function GUI() {
  ...
  const [wordSize, setWordSize] = useState(""); // For final value
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <Card className="flex flex-col w-[800px]">
          ...
          <CardContent className="flex flex-row gap-4">
            <Input
              ...
              className="w-full"
              value={wordSizeInput > 0 ? wordSizeInput : ""} // Use the temporary state for the input
        ...
        {wordSize ? (
          <>
            ...
            <RegisterCard wordSize={wordSize} />
